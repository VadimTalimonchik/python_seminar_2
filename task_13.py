...
day = int(input('Введите количество рассматриваемых дней: '))
k = 0
max = 0
for i in range(day):
    temp = int(input('Cреднесуточная температура в соответствующий день: '))
    if temp > 0:
        k += 1
    else:
        if max < k:
...
print('Cамая длинная оттепель длилась', max, 'дня(ей).')



# требуется доработка - если ввести все положительные числа, то в итоге выходит 0